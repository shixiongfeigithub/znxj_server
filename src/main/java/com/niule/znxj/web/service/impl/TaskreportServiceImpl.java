...
import com.niule.znxj.web.model.response.WebChartRes;
import com.niule.znxj.web.model.response.WebChartRes2;
import com.niule.znxj.web.model.response.WebChartResBean;
import com.niule.znxj.web.model.response.WebChartResBean2;
...
//    dadiyreportlist
    @Override
    public List<Taskreportinfo> dadiyreportlist(Long taskidstr) {
...
//    }
    ...
    public int delTaskLog(Long id) {
        ...
        taskreportinfo.setId(id);
        taskreportinfo.setLogcat(null);
        return taskreportinfoMapper.updateByPrimaryKeySelective(taskreportinfo);
    }
    ...
    @Override
    public PageInfo<Taskreportinfo> reportList(HashMap<String,Object> map) {
        int page= (int) map.get("page");
        ...
        if(taskid != null) {
            ...
            if(time1!=null&&time2!=null)
                criteria.andDonetimeBetween(DateUtils.parseDate(time1),DateUtils.parseDate(time2));
...
//            criteria.andStarttimeIsNotNull().andEndtimeIsNotNull();
        ...
        return taskreportinfoMapper.reportList3(map);
    }
...
//        return res;
     ...
     * 设备状态情况信息统计列表
     */
    public PageInfo<Reportcontent>  equipSateInfo2(int page,int size,String checkname,String monthstr,String sitename,String areaname,String equipname) {
        PageHelper.startPage(page,size);
...
//        PageHelper.startPage(page,size);
     ...
     * @return
     */
    public List<Reportcontent>  equipSateInfo3(String checkname,String monthstr,String areaname,String equipname) {
        List<Reportcontent> pageInfo=null;
        ReportcontentExample reportcontentExample=new ReportcontentExample();
     ...
     * @return
     */
    public WebChartRes2 equipStateChart(int page,int size,String checkname,String monthstr,String areaname,String equipname){
        List<Reportcontent> equipstates=equipSateInfo3(checkname,monthstr,areaname,equipname);
