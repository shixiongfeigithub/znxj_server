        ...
        function  getChecknameByid(recordid,dataname){
            $.ajax({
                ...
                success:function(data){
                    ...
                    var isDel=confirm("有"+data+"个巡检项与该数据关联，还要继续删除吗？");
                    if (isDel!=true) {
                        return false;
                        showtask();
                    }else {
                        delrecord(recordid,dataname);
                    }
                }
            });
        }
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            ...
                            <div style="float: right;">
                                <shiro:hasPermission name="add:data">
                                    <a href="adddaterecord.jsp" id="button" class="btn btn-primary" style="margin-top: -6px;">添加数据项</a>
                                </shiro:hasPermission>
                            </div>
                        ...
                        <ul id="myTab" class="nav nav-tabs">
                            ...
                            <li><shiro:hasPermission name="add:apk"><a href="showappversion?page=1">Android APK更新</a></shiro:hasPermission></li>
                                        ...
                                        <tr>
                                            <td>
                                                <shiro:hasPermission name="upd:data">
                                                    <a href="querybydateid?id=${datarecord.id}"><i class="glyphicon glyphicon-edit red "></i></a>
                                                </shiro:hasPermission>
                                                <shiro:hasPermission name="del:data">
                                                    <a href="javascript:void(0)" onclick="getChecknameByid(${datarecord.id},'${datarecord.name}')">
