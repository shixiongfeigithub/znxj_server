            ...
            <ul class="nav nav-pills nav-stacked main-menu">
                <li class="accordion">
                    ...
                    <ul class="nav nav-pills nav-stacked">
                        <li id="userInfo"><shiro:hasPermission name="item:admin"><a href="showadmin?page=1" target="center"><i class="glyphicon glyphicon-user"></i>管理员管理</a></shiro:hasPermission></li>
