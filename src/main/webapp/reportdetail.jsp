    ...
    <script type="text/javascript">
        $(function(){
           ...
           for(var i=0;i<aa.length;i++){
               ...
               var skipequipname;
               /*设置巡检项的状态*/
               var checktype2=aa[i].checktype;
//               状态项numvalue"正常" errorcontennt="-"
               /*设置最低值和最高值*/
               ...
               var numvalue=aa[i].numvalue==''?'-':aa[i].numvalue;
               if(aa[i].areaskip=="1"){
                   ...
                   if(aa[i].equipmentskip=="1"){
                       ...
                       if(normalmax1!='-'&&numvalue!='-'){
                           if(parseInt(numvalue)>parseInt(normalmax1)){
                               var numvalue2=numvalue+"↑↑";
                               html="<tr><td style='color:red;'>"+skiparea+
                                       ...
                                       "</td><td>"+normalmax1+"</td><td>"+lowerwarning1+"</td><td>"+upperwarning1+"</td><td style='color:red;'>"+numvalue2+
                                       "</td><td>"+(aa[i].recordname==''?'-':aa[i].recordname)+"</td><td>"+(aa[i].unitname==''?'-':aa[i].unitname)+
                                       "</td><td><a href='javascript:void(0)' onclick=findbystate('"+error+"','"+image+"','"+audio+"','"+video+"')>"+error+
                                       "</a></td></tr>";
                           }

                           if(parseInt(numvalue)<parseInt(normalmin1)){
                               var numvalue3=numvalue+"↓↓";
                               html="<tr><td style='color:red;'>"+skiparea+
                                       "</td><td style='color:red;'>"+skipequipname+"</td><td>"+aa[i].checkname+
                                       "</td><td>"+checktype2+"</td><td>"+operatetime+"</td><td>"+normalmin1+
                                       "</td><td>"+normalmax1+"</td><td>"+lowerwarning1+"</td><td>"+upperwarning1+"</td><td style='color:red;'>"+numvalue3+
                                       "</td><td>"+(aa[i].recordname==''?'-':aa[i].recordname)+"</td><td>"+(aa[i].unitname==''?'-':aa[i].unitname)+
                                       "</td><td><a href='javascript:void(0)' onclick=findbystate('"+error+"','"+image+"','"+audio+"','"+video+"')>"+error+
                                       "</a></td></tr>";
                           }
                           ...
                           html="<tr><td style='color:red;'>"+skiparea+
                                   "</td><td style='color:red;'>"+skipequipname+"</td><td>"+aa[i].checkname+
                                   "</td><td>"+checktype2+"</td><td>"+operatetime+"</td><td>"+normalmin1+
                                   "</td><td>"+normalmax1+"</td><td>"+lowerwarning1+"</td><td>"+upperwarning1+"</td><td>"+numvalue+
                                   "</td><td>"+(aa[i].recordname==''?'-':aa[i].recordname)+"</td><td>"+(aa[i].unitname==''?'-':aa[i].unitname)+
                                   "</td><td><a href='javascript:void(0)' onclick=findbystate('"+error+"','"+image+"','"+audio+"','"+video+"')>"+error+
                                   "</a></td></tr>";
                        }
                   ...
                   if(aa[i].equipmentskip=="1"){
                       ...
                       if(normalmax1!='-'&&numvalue!='-'){
                           ...
                           if((parseInt(normalmin1)<=parseInt(numvalue))&&(parseInt(numvalue)<=parseInt(normalmax1))){
                               html="<tr><td>"+skiparea+
                                       "</td><td style='color:red;'>"+skipequipname+"</td><td>"+aa[i].checkname+
                                       "</td><td>"+checktype2+"</td><td>"+operatetime+"</td><td>"+normalmin1+
                                       "</td><td>"+normalmax1+"</td><td>"+lowerwarning1+"</td><td>"+upperwarning1+"</td><td>"+numvalue+
