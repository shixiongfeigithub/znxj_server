...
<head>
    ...
    <script type="text/javascript">
        function showdata(){
            ...
            location.href="reportcount?page=1&taskid="+taskid+"&operationtime="+operationtime+"&type="+type+"&reportstate="+reportstate;
        }
        function refer(){
            var type=$("#type").val();
                    ...
                    <div class="box-inner">
                                ...
                                <div class="box-content">
                                                    ...
                                                    <%--</c:if>--%>
                                                        ...
                                                        <%--<c:if test="${reports.numvalue!=''}">--%>
                                                            <%--<c:if test="${reports.normalmin!=''}">--%>
                                                                ...
                                                                <%--<c:if test="${reports.normalmax!=''}">--%>
                                                                    <%--<c:if test="${reports.numvalue > reports.normalmax}"><span style="color: red;">${reports.numvalue}↑↑</span></c:if>--%>
                                                                    <%--<c:if test="${reports.normalmin<=reports.numvalue <= reports.normalmax}"><span>${reports.numvalue}</span></c:if>--%>
                                                                <%--</c:if>--%>
                                                            <%--</c:if>--%>
                                                        <%--</c:if>--%>
                                    ...
                                    <div style="height: 50px;width: 500px;text-align: center;margin-left: 300px;">
                                        <a href="reportcount?page=1&taskid=${taskid}&type=${type}&taskname=${taskname}&donetime=${donetime}">第一页</a>
                                        <c:if test="${reportinfos.pageNum>1}">
                                            <a href="reportcount?page=${reportinfos.pageNum-1}&taskid=${taskid}&type=${type}&taskname=${taskname}&donetime=${donetime}">上一页</a>
                                        </c:if>

                                        <c:if test="${reportinfos.pageNum<reportinfos.pages}">
                                            <a href="reportcount?page=${reportinfos.pageNum+1}&taskid=${taskid}&type=${type}&taskname=${taskname}&donetime=${donetime}">下一页</a>
                                        </c:if>

                                        <a href="reportcount?page=${reportinfos.pages}&taskid=${taskid}&type=${type}&taskname=${taskname}&donetime=${donetime}">最后一页</a>
