                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        html += "<tr><td><input type='checkbox' name='allcheckitem'></td>" +
                                "<td>" + data[i].customid + "</td><td width='30%'>" + (data[i].type == 1 ? '状态项' : data[i].type == 2 ? '记录项' : '枚举项') +
...
//        }
    ...
    function addequip() {
        ...
        for (var i = $("#selectsllequip")[0].checked ? 1 : 0; i < equipment.length; i++) {
            ...
            //添加设备
            res.areas[selectedareaindex].equipments.push({
                equipment: equipmentdata[equipment[i].rowIndex - 1],
    ...
    function showdata(obj) {
        ...
        if (recordid == undefined) {
            ...
            var data = res.areas[selectedareaindex].equipments[selectedequipmentindex].checkItems[selecteditemindex].item;
            var url = JSON.stringify(data);
            /* var check= $("#check").find("input[type='checkbox']:checked").parent().parent();*/
            var datarecord = $("#datarecord");
            datarecord.empty();
            if (data.recordid == null) {
                datarecord.append("<p>类型：" + (data.type == 1 ? '状态项' : data.type == 2 ? '记录项' : '枚举项') + "</p>");
            } else {
    ...
    function edit(obj) {
        ...
        var item = res.areas[selectedareaindex].equipments[selectedequipmentindex].checkItems[selecteditemindex].item;
...
//        sortTime()
    ...
    function sortTime() {
        ...
        for (var i = 0; i < list.length; i++) {
            alert(list.get(i).val().value);
//                var strs1 = list.get(j).split(':')
//                var strs2 = list.get(j + 1).split(':')
//                if (strs1[1] > strs2[1]) {
//
//                }
//            }
                                    ...
                                    <table class="table table-striped table-bordered table-hover bootstrap-datatable datatable responsive dataTable">
                                        <tr>
                                            <td class="form-inline" colspan="3">
                                                ...
                                                <label class="control-label" for="directorid"
                                                       style="margin-left: 50px;">负责人:</label>
                                        ...
                                        <tr>
                                            <td class="form-inline">
                                                ...
                                                <input type="text" class="form-control" id="idtype" name="identifyingid"
                                                       required placeholder="任务号不能为空">
                                            </td>
                                            <td class="form-inline">
                                                <label class="control-label" for="taskname">任务名:</label>
                                                <input type="text" name="customid" class="form-control" id="taskname"
                                                       placeholder="任务名不能为空">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="form-inline" colspan="2">
                                                ...
                                                <span>任务描述:</span>
                                                <textarea class="form-control" id="username" name="taskdesc" rows="3"
                                                          cols="150" required placeholder="只能输入0-15个字符"></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="form-inline">
                                                <label class="control-label" for="pwd2">创建人:</label>
                                                <input type="text" class="form-control" style="width: 300px;" id="pwd2"
                                                       name="createuser" required placeholder="创建人不能为空">
                                            </td>
                                            <td class="form-inline">
                                                <label class="control-label" for="pwd3">创建时间:</label>
                                                <input type="text" id="pwd3" name="createtime" class="form-control"
                                                       onClick="WdatePicker()">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td class="form-inline">
                                                ...
                                                <input type="text" class="form-control" style="width: 300px;" id="pwd4"
                                                       name="revieweduser" required placeholder="审核人不能为空">
                                            </td>
                                            <td class="form-inline">
                                                <label class="control-label" for="pwd7">审核时间:</label>
                                                <input type="text" class="form-control" style="width: 300px;" id="pwd7"
                                                       onClick="WdatePicker()" name="reviewedtime" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="form-inline">
                                                <label class="control-label" for="pwd5">批准人:</label>
                                                <input type="text" class="form-control" style="width: 300px;" id="pwd5"
                                                       name="approveuser" required placeholder="批准人不能为空">
                                            </td>
                                            <td class="form-inline">
                                                <label class="control-label" for="pwd6">批准时间:</label>
                                                <input type="text" class="form-control" style="width: 300px;" id="pwd6"
                                                       onClick="WdatePicker()" name="approvetime" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="form-inline">
                                                <label class="control-label" for="banben">任务版本号:</label>
                                                <input type="text" class="form-control" style="width: 300px;" value="1"
                                                       id="banben" name="taskversion" required placeholder="版本号不能为空">
                                            </td>
                                            <td class="form-inline">
                                                <label class="control-label" for="pwd8">最长执行时间(单位：分钟):</label>
                                                <input type="text" class="form-control" style="width: 300px;" id="pwd8"
                                                       name="maxduration" required placeholder="请输入整数">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="form-inline">
                                        ...
                                        <tr>
                                            <td colspan="2"><input type="button" class="btn btn-primary"
                                                                   value="下一步 区域设置" onclick="second()">
                                                <input type="reset" class="btn btn-primary white" value="取消"
                                ...
                                <div id="second" style="display: none">
                                    ...
                                    <div style="width: 230px;height: 420px;position:relative;float: left;">
                                        ...
                                        <a href="javascript:void(0)" onclick="model()">
                                            <input type="button" class="btn btn-inverse btn-default btn-lg"
                                                   value="添加区域">
                                        </a>
                                    ...
                                    <div style="width: 30px;height: 400px;position:relative;float: left;padding-top: 130px;padding-left: 3px;">
                                        <a href="javascript:void(0);" onclick="areadataupper()"><i
                                                class="glyphicon glyphicon-arrow-up black" style="font-size: 30px;"></i></a><br/><br/><br/><br/>
                                        <a href="javascript:void(0);" onclick="areadatalower()"><i
                                                class="glyphicon glyphicon-arrow-down black"
                                    ...
                                    <div style="width: 230px;height: 420px;position:relative;float: left;margin-left:30px;">
                                        ...
                                        <input type="button" class="btn btn-inverse btn-default btn-lg" value="删除设备"
                                               onclick="delequip('#equipul')">
                                    </div>
                                    <div style="width: 30px;height: 400px;position:relative;float: left;padding-top: 130px;padding-left: 3px;">
                                        <a href="javascript:void(0);" onclick="equipdataupper()"><i
                                                class="glyphicon glyphicon-arrow-up black" style="font-size: 30px;"></i></a><br/><br/><br/><br/>
                                        <a href="javascript:void(0);" onclick="equipdatalower()"><i
                                                class="glyphicon glyphicon-arrow-down black"
                                                style="font-size: 30px;"></i></a>
                                    </div>
                                    <c:if test="${type==0 || type==1}">
                                        <div style="width: 270px;height: 420px;position:relative;float: left;margin-left:30px;">
                                            ...
                                            <input type="button" class="btn btn-inverse btn-default btn-lg"
                                                   value="添加巡检项" onclick="showcheck()">
                                            <input type="button" class="btn btn-inverse btn-default btn-lg"
                                                   value="删除巡检项" onclick="delitem('#checkul')">
                                        </div>
                                        <div style="width: 30px;height: 400px;position:relative;float: left;padding-top: 130px;margin-left: -3px;">
                                            <a href="javascript:void(0);" onclick="checkdataupper()"><i
                                                    class="glyphicon glyphicon-arrow-up black"
                                                    style="font-size: 30px;"></i></a><br/><br/><br/><br/>
                                            <a href="javascript:void(0);" onclick="checkdatalower()"><i
                                                    class="glyphicon glyphicon-arrow-down black"
                                                    style="font-size: 30px;"></i></a>
                                        </div>
                                    ...
                                    <div style="margin-top: 35px;">
                                        <a href="#"><input type="button" class="btn btn-inverse btn-default btn-lg"
                                                           value="上一步 基本设置" onclick="first()"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="#"><input type="button" class="btn btn-inverse btn-default btn-lg"
                                                           value="下一步 循环执行设置" onclick="third()"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="showtaskplan?page=1&type=${type}"><input type="button"
                                                                                          class="btn btn-inverse btn-default btn-lg"
                                                                                          value="取消"></a>
                                    </div>
                                </div>
                                <div id="third" style="display: none">
                                    ...
                                    <div style="margin-top: 20px;" id="timeSystem">
                                        <div style="border: 1px solid gray;width: 800px;" id="checkedradio">
                                            ...
                                            <div class="form-inline" style="margin-top: 25px;margin-bottom: 25px;">
                                                ...
                                                <div style="margin-left: 25px;font-size:15px;position:relative;float: left;margin-top: 60px;">
                                                    执行列表：
                                                </div>
                                                <div id="name4"
                                                     style="position:relative;float: left;margin-top: 25px;width:350px;height:150px;border: 1px solid gray;overflow: auto"></div>

                                                <div style="position:relative;float: left;margin-top: 40px;margin-left: 25px;">
                                                    <input type="button" id="addtimee" value="添加"
                                                           class="btn btn-inverse btn-default btn-lg"
                                                           onclick="addtime()"><br>
                                                    <input type="button" id="deltime" value="删除"
                                                           class="btn btn-inverse btn-default btn-lg"
                                                           style="margin-top:15px;" onclick="deltime1()">
                                                </div>
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div style="margin-top: 20px;">
                                        <a href="#" style="margin-left: 35px;">
                                            <input type="button" class="btn btn-inverse btn-default btn-lg"
                                                   value="上一步 区域设置" onclick="second()">
                                        </a>
                                        <a href="#" style="margin-left: 35px;">
                                            <input type="button" class="btn btn-inverse btn-default btn-lg" value="保存"
                                                   onclick="submitarea()">
                                        </a>
...
<div aria-hidden="false" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal" class="modal fade in"
    ...
    <div class="modal-dialog" style="z-index: 9999;width: 800px;">
        <div class="modal-content">
            <div id="arealist" style="height:700px;">
                ...
                <div class="modal-body">
                    <div style="height:500px;width:100%;margin:5px 10px;overflow: scroll;overflow-x:hidden;">
                        <table class="table table-striped table-bordered table-hover bootstrap-datatable datatable responsive dataTable"
                               id="area">
                            <tr>
                                <th><input type="checkbox" name="selectallarea" id="selectallarea"
                                           onclick="selectallarea(this,'allarea')"> 全选/全不选
                                </th>
                                <th>区域编号</th>
                                <th>区域名称</th>
                                <th>区域描述</th>
            ...
            <div id="equipmentlist" style="height:700px;">
                <div class="modal-header">
                    <button data-dismiss="modal" class="close" type="button">×</button>
                    <h3>设备列表</h3>
                </div>
                ...
                <div class="modal-body">
                    <div style="height:500px;width:100%;margin:5px 10px;overflow: scroll;overflow-x:hidden;">
                        <table class="table table-striped table-bordered table-hover bootstrap-datatable datatable responsive dataTable"
                               id="equipment">
                            <tr>
                                <th><input type="checkbox" name="allequip" id="selectsllequip"
                                           onclick="selectallarea(this,'allequip')">全选/全不选
                                </th>
                                <th>设备编号</th>
                                <th>设备名称</th>
                                <th>设备描述</th>
            ...
            <div id="checklist" style="height:700px;">
                <div class="modal-header">
                    <button data-dismiss="modal" class="close" type="button">×</button>
                ...
                <div class="modal-body">
                    <div style="height:500px;width:100%;margin:5px 10px;overflow: scroll;overflow-x:hidden;">
                        <table class="table table-striped table-bordered table-hover bootstrap-datatable datatable responsive dataTable" id="check">
                            <tr>
                                <th><input type="checkbox" name="allcheckitem" id="selectallcheck"
                                           onclick="selectallarea(this,'allcheckitem')">全选/全不选
                                </th>
                                <th>编号</th>
                                <th>类型</th>
                                <th>名称</th>
