...
<script type="text/javascript">
    ...
    function showtask(){
        window.location="showtaskplan4?page=1&type=2";
    }
</script>
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2>
                                <i class="glyphicon glyphicon-globe"></i> HSE隐患排查--编辑
                            </h2>
                        </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover bootstrap-datatable datatable responsive dataTable">
                                        ...
                                        <tr>
                                            <td class="form-inline">
                                                ...
                                                <input type="text" class="form-control" style="width: 300px;" id="banben" name="taskversion" required value="${taskplaninfo.taskversion}">
                                            </td>
                                            <td class="form-inline">
                                    ...
                                    <div style="border: 1px solid gray;width: 800px;" id="checkedradio">
                                        ...
                                        <div class="form-inline"style="margin-top: 25px;margin-bottom: 25px;">
                                            ...
                                            <div style="position:relative;float: left;margin-top: 40px;margin-left: 25px;">
                                                ...
                                                <input type="button" id="deltime" value="删除" class="btn btn-inverse btn-default btn-lg" style="margin-top:15px;" onclick="deltime()">
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
