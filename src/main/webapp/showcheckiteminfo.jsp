...
<head>
    ...
    <script type="text/javascript">
        ...
        function showtask(){
            window.location="showallcheck?page=1";
        }
    </script>
</head>
<body>
                        ...
                        <div class="box-content">
                            <div class="form-inline" style="margin-bottom: 20px;">
                                <form action="showallcheck?page=1" method="post">
                                    ...
                                    <input type="text" class="form-control" style="width: 300px;" id="name2" name="itemname" value="${param.itemname}">
                                    <input type="submit" class="btn btn-primary" value="搜索">
                                    <shiro:hasPermission name="add:check">
                                        <a href="toaddcheck" id="button" class="btn btn-primary" style="margin-left:250px;">添加巡检项</a>
                                    </shiro:hasPermission>
                                </form>
                            </div>
                        </div>
                                ...
                                <tr>
                                    <td>
                                        <shiro:hasPermission name="upd:check">
                                            <a href="querybycheckid?id=${check.id}"><i class="glyphicon glyphicon-edit red "></i></a>
                                        </shiro:hasPermission>
                                        <shiro:hasPermission name="del:check">
                                            <a href="javascript:void(0)" onclick="delcheck(${check.id},'${check.customid}')"><i class="glyphicon glyphicon-trash"></i></a>
                                        </shiro:hasPermission>
                                        <%--<shiro:hasPermission name="item:checkdetail">--%>
                                            <a href="querycheckdetail?id=${check.id}"><i class="glyphicon glyphicon-info-sign blue "></i></a>
                                        <%--</shiro:hasPermission>--%>
                                    </td>
