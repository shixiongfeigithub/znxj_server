...
<script type="text/javascript"->
    ...
    function  showdata(obj) {
        ...
        if (recordid==undefined) {
            ...
            $.ajax({
                url:"showdatarecord?recordid="+recordid,
                type: "post",
                dataType: "json",
                success: function (data) {
                    if(data==""){
                        ...
                        datarecord.empty();
                        datarecord.append("<p>类型："+data.type+"</p>" +
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2>
                                <i class="glyphicon glyphicon-globe"></i> 计划巡检任务--详情
                            </h2>
                        </div>
                            ...
                            <form action="" method="post" id="tasksubmit">
                                    ...
                                    <table class="table table-striped table-bordered table-hover bootstrap-datatable datatable responsive dataTable">
                                        ...
                                        <tr>
                                            <td class="form-inline" colspan="2">
                                                ...
                                                <textarea  class="form-control" id="username" name="taskdesc" rows="3" cols="150" readonly>${taskplaninfo.identifyingid}</textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="form-inline">
                                        ...
                                        <tr>
                                            ...
                                            <td class="form-inline">
                                                <label class="control-label" for="pwd8">最长执行时间:</label>
                                ...
                                <div id="second" style="display: none">
                                    ...
                                    <div style="margin-top: 35px;">
                                        ...
                                        <a href="showtaskplan2?page=1&type=1"><input type="button" class="btn btn-inverse btn-default btn-lg" value="取消"></a>
                                    </div>
                                </div>
                                <div id="third" style="display: none">
                                    <div style="border: 1px solid gray;width: 800px;" id="checkedradio">
                                        ...
                                        <div class="form-inline" >
                                            <input id="radion1" type="radio" name="issingletime" ${taskplaninfo.issingletime eq '1' ? 'checked' : ''} value="1" checked  style="margin-top:15px;margin-left: 15px;margin-bottom: 25px;">单日单次执行<br/>
                                        ...
                                        <div class="form-inline"style="margin-top: 25px;margin-bottom: 25px;">
                                            ...
                                            <input id="radion2" type="radio" name="issingletime" ${taskplaninfo.issingletime eq '0' ? 'checked' : ''} value="0" checked  style="margin-top:15px;margin-left: 15px;margin-bottom: 25px;">单日多次执行<br/>
                                    ...
                                    <div style="margin-top: 25px;">
                                        ...
                                        <a href="showtaskplan2?page=1&type=1" style="margin-left: 35px;">
