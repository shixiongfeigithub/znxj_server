$(document).ready(function () {
   ...
   var currentTheme = $.cookie('currentTheme') == null ? defaultTheme : $.cookie('currentTheme');
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', applicationpath+'/charisma/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', applicationpath+'/charisma/css/bootstrap-' + themeName + '.min.css');
        }
